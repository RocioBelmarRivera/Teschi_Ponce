...
public class Consulta1 extends javax.swing.JFrame {
        CConsultasI modelos = new CConsultasI();
    ...
    private boolean campos_vacios() {
        return jTFMatricula.getText().isEmpty();
    }
        ...
        if (campos_vacios()) {
           ...
           //     id = Integer.parseInt((String) modelTabla.getValueAt(jTDatos.getSelectedRow(), 0));
                ...
                modelos.busca_consulta1(matricula);
            } catch (Exception e) {
            }
        }
        limpiar();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Mostrar el historial academico de cualquier alumno \npor medio de la matricula o el nombre completo. \nEl historial debera de mostrar: clave de la asignatura, \nnombre completo de la asignatura, docente que\n impartio la asignatura, fecha al cual se impartio el curso, \norigen del curso, calificacion obtenida.\n");
        ...
        jTDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Asignatura", "Creditos", "Semestre", "Periodo_inicio", "Periodo_termino", "Calificación"
            }
        ));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(60, 60, 60)
                        .addComponent(jTFMatricula, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(148, 148, 148))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
