 ...
 * @author HP
 */
public class JFRegistroJefesCarrera extends javax.swing.JFrame {

    /** Creates new form JFRegistroJefesCarrera */
    public JFRegistroJefesCarrera() {
        initComponents();
...
//String regexmatricula = "^[0-9]{10}$";  
String regexmatricula = "^[A-Z]{4}-\\d{4}$";
...
String correo;
  ...
  // Obtener el valor seleccionado en el JComboBox
    ...
    return ultimoID;
              ...
              public int insertaJefeDeCarrera(String matricula,String telefono,String correo){ 
            ...
            if (id_persona==0) {//si el ultimo id es 0
             ...
             System.out.println("direccion id ultimo:"+id_persona);
                ...
                try {
                    ...
                    queryInserta3.insertarAdministrador(matricula, id_persona);
                    queryInserta4.insertaTelefono(telefono, id_persona);
                    queryInserta5.insertaCorreo(correo, id_persona);
                    
                    
                    
                      CUtilitario.msg("Se inserto correctamente el jefe de carrera", "inserta jefe de carrera");
                } catch (Exception e) {
                    System.out.println("no se inserto persona por problamas");
                }
    ...
    return ultimoID;
     ...
     public boolean verificaMatricula(String matricula){
        ...
        try {
         ...
         String resultado= queryBusca5.BuscaMatriculaAdministrador(matricula);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro Jefes de division");
        ...
        jLabel13.setText("Matricula del alumno");

        jLabel14.setText("Correo electronico:");

        jLExtensionCorreo.setText("@teschi.edu.mx");

        jLabel9.setText("DATOS ESCOLARES");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (validaCampos()) {
            ...
            if (verificaMatricula(matricula)) {
                CUtilitario.msg_adver("Esa matricula ya existe ya esta aregistrada", "verifica matricula");
            }else{

                if (verificaTelefono(telefono)) {
                    CUtilitario.msg_adver("El numero telefonico ya existe y esta registrado, cambielo", "verifica matricula");
                }else{

                    if (verificaCorreo(correo)) {
                        CUtilitario.msg_adver("El correo electronico ya existe y esta registrado, cambielo", "verifica correo electronico");
                    }else{
                        insertaJefeDeCarrera(matricula, telefono, correo);
                        limpiar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRegistroJefesCarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRegistroJefesCarrera().setVisible(true);
            }
        });
    }
