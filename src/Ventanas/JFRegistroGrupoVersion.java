 ...
 * @author HP
 */
public class JFRegistroGrupoVersion extends javax.swing.JFrame {

    /**
     * Creates new form JFRegistroGrupoVersion
     */
    public JFRegistroGrupoVersion() {
        initComponents();
    ...
    grupo = (String) JCBGrupo.getSelectedItem();  // Asignamos el valor seleccionado a la variable estado
      ...
      public void cargaComboBox(JComboBox combo, int metodoCarga) {
        ...
        public boolean insertaGrupoVersion(String version,String grupo){ 
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro Grupo_Version");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(JCBGrupo, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        insertaGrupoVersion(version, grupo);
        limpiar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRegistroGrupoVersion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRegistroGrupoVersion().setVisible(true);
            }
        });
    }
