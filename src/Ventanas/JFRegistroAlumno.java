 ...
 * @author HP
 */
public class JFRegistroAlumno extends javax.swing.JFrame {

    /**
     * Creates new form JFRegistroAlumno
     */
    public JFRegistroAlumno() {
        initComponents();
...
String correo;
  ...
  // Obtener el valor seleccionado en el JComboBox
    ...
    return ultimoID;
              ...
              public int insertaAlumno(String matricula,String telefono,String correo){ 
            ...
            if (id_persona==0) {//si el ultimo id es 0
             ...
             System.out.println("direccion id ultimo:"+id_persona);
                ...
                try {
                    ...
                    queryInserta3.insertaAlumno(matricula, id_persona);
    ...
    return ultimoID;
     ...
     public boolean verificaMatricula(String matricula){
        ...
        try {
         ...
         String resultado= queryBusca5.buscaMatricula(matricula);
            ...
            if (verificaMatricula(matricula)) {
                ...
                if (verificaTelefono(telefono)) {
                    ...
                    if (verificaCorreo(correo)) {
                        ...
                        insertaAlumno(matricula, telefono, correo);
                        limpiar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRegistroAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRegistroAlumno().setVisible(true);
            }
        });
    }
