 ...
 * @author HP
 */
public class JFRegistroDocenteGrupo extends javax.swing.JFrame {

    /**
     * Creates new form JFRegistroDocenteGrupo
     */
    public JFRegistroDocenteGrupo() {
        initComponents();
        
        
        
        cargaComboBox(JCBDocente, 1);
        cargaComboBox(JCBGrupo, 2);
   ...
   private CBusca queryBusca2 = new CBusca();
    ...
    docente=(String) JCBDocente.getSelectedItem(); 
    ...
    grupo = (String) JCBGrupo.getSelectedItem();  // Asignamos el valor seleccionado a la variable estado
      ...
      public void cargaComboBox(JComboBox combo, int metodoCarga) {
        ...
        try {
            switch (metodoCarga) {
                case 1:
                    datosListas = queryCarga1.cargaNombreCompletosDocente();
                    ...
                    break;
                     ...
                     case 2:
                    datosListas = queryCarga.cargaNombreGrupo();
                    for (int i = 0; i < datosListas.size(); i++) {
                        listas.addElement(datosListas.get(i));
                    }
                    datosListas.clear();
        ...
        public boolean insertaDocente_grupo(String docente,String grupo){ 
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro Docente_Grupo");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(JCBDocente, 0, 251, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRegistroDocenteGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRegistroDocenteGrupo().setVisible(true);
            }
        });
    }
